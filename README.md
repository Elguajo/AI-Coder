...
# Проверка активации - должен показаться путь к Python внутри venv
where python
# или
python --version
```
...
После активации виртуального окружения, в начале командной строки появится префикс `(venv)`, что указывает на то, что окружение активно.
