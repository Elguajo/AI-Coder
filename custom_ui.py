def build_custom_interface():
    ...
    # Создание интерфейса
    with gr.Blocks(css=CSS_FILE, title="Elcoder - Чат-бот для кодинга") as interface:
        # Шапка
        ...
        with gr.Tabs(elem_classes="tab-nav") as tabs:
            ...
            with gr.TabItem("💬 Чат", id="chat"):
                ...
                export_result = gr.Textbox(label="Результат экспорта", visible=False)
        ...
        with gr.Box(elem_classes="footer"):
            gr.Markdown("Elcoder | Локальный чат-бот для кодинга на основе DeepSeek-coder")
        ...
        def export_session_callback():
            ...
            return gr.update(value=f"Сессия экспортирована в {file_path}", visible=True)
        ...
        export_btn.click(export_session_callback, outputs=[export_result])
